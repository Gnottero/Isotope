#> This function will run on datapack loading
    ...
    #> Place an oak wall sign to get item names and a barrel used for item manipulation
        ...
        execute unless block -30000000 1 1603 minecraft:barrel run setblock -30000000 1 1603 minecraft:barrel[facing=up]
